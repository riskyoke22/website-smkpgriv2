...
export default function DKVPage() {
  ...
  useEffect(() => {
    const fetchProgramContent = async () => {
      try {
        const response = await fetch('/api/program-content/dkv')
        if (response.ok) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto py-20">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
            Mencetak desainer kreatif dan profesional yang siap bersaing di industri kreatif dan media digital
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-blue-900 to-blue-800 rounded-2xl p-8 md:p-12 text-white shadow-xl">
              ...
              <p className="text-lg leading-relaxed">
                Program Keahlian Desain Komunikasi Visual (DKV) SMKS PGRI Wonoasri dirancang untuk mencetak
                lulusan yang kompeten di bidang desain grafis, fotografi, videografi, animasi, dan multimedia.
                Siswa akan belajar menguasai berbagai software industri standar seperti Adobe Photoshop,
                Illustrator, After Effects, Premiere Pro, dan lainnya. Program ini menggabungkan teori desain
                dengan praktik langsung untuk mempersiapkan siswa menjadi desainer profesional yang siap
                bekerja di berbagai industri kreatif.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <p className="text-foreground/80 leading-relaxed text-lg">
                Menjadi program keahlian DKV unggulan yang menghasilkan lulusan berkompeten, kreatif,
                inovatif, dan berkarakter dalam bidang desain komunikasi visual yang diakui di tingkat
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <ul className="space-y-3 text-foreground/80">
                <li className="flex items-start gap-2">
                  ...
                  <span>Mencetak lulusan yang mampu menciptakan karya desain berkualitas tinggi</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-500 mt-1">✓</span>
                  <span>Mengembangkan kreativitas dan kemampuan berpikir visual siswa</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-500 mt-1">✓</span>
                  <span>Mempersiapkan siswa untuk bersaing di industri kreatif digital</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-500 mt-1">✓</span>
                  <span>Menanamkan etika profesional dalam praktik desain</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground/70 mt-6 max-w-3xl mx-auto">
              Siswa DKV memiliki kesempatan PKL di berbagai perusahaan kreatif terkemuka
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <p className="text-foreground/60 text-sm mt-4 text-center">
                Galeri karya siswa DKV terpilih
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-yellow-500 mx-auto rounded-full" />
            <p className="text-lg text-foreground/70 mt-6 max-w-3xl mx-auto">
              Dokumentasi kegiatan dan pembelajaran siswa DKV
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Siap Menjadi Desainer Profesional?</h2>
          <p className="text-xl text-yellow-400 mb-8 max-w-2xl mx-auto">
            Bergabunglah dengan Program Keahlian Desain Komunikasi Visual SMKS PGRI Wonoasri dan wujudkan karir di industri kreatif!
          </p>
      ...
      <footer className="bg-blue-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-blue-200">
            © 2025 SMKS PGRI Wonoasri - Program Keahlian Desain Komunikasi Visual
          </p>
        </div>
      </footer>
    </div>
