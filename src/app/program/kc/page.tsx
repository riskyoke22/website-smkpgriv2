...
import { ArrowLeft, GraduationCap, Target, Award, BookOpen, Briefcase, Building2, Trophy, Shield, Image as ImageIcon, Quote, Sparkles, Loader2 } from 'lucide-react'
...
export default function KCPage() {
  ...
  useEffect(() => {
    const fetchProgramContent = async () => {
      try {
        const response = await fetch('/api/program-content/kc')
        if (response.ok) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto py-20">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
            Mencetak profesional kecantikan yang kompeten dan siap bersaing di industri kecantikan dan perawatan estetika
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-blue-900 to-blue-800 rounded-2xl p-8 md:p-12 text-white shadow-xl">
              ...
              <p className="text-lg leading-relaxed">
                Program Keahlian Tata Kecantikan (KC) SMKS PGRI Wonoasri dirancang untuk mencetak lulusan yang
                kompeten di bidang tata rias, perawatan kulit, hair styling, dan manajemen kecantikan. Siswa akan
                belajar teknik kecantikan profesional mulai dari dasar hingga mahir, termasuk makeup artistry,
                skincare, nail art, spa therapy, dan manajemen bisnis kecantikan. Program ini menggabungkan
                pengetahuan teori dengan praktik intensif untuk mempersiapkan siswa menjadi profesional kecantikan
                yang siap bekerja di salon, spa, beauty clinic, maupun membuka usaha sendiri.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <p className="text-foreground/80 leading-relaxed text-lg">
                Menjadi program keahlian Tata Kecantikan unggulan yang menghasilkan lulusan profesional, terampil,
                inovatif, dan berkarakter dalam bidang kecantikan yang diakui di tingkat nasional maupun internasional.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <ul className="space-y-3 text-foreground/80">
                <li className="flex items-start gap-2">
                  ...
                  <span>Mencetak lulusan yang mampu memberikan layanan kecantikan profesional</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-500 mt-1">✓</span>
                  <span>Mengembangkan kreativitas dan seni dalam tata rias dan perawatan kecantikan</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-500 mt-1">✓</span>
                  <span>Mempersiapkan siswa untuk bersaing di industri kecantikan modern</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-500 mt-1">✓</span>
                  <span>Menanamkan etika profesional dan kewirausahaan di bidang kecantikan</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              'Tata Rias Wajah & Makeup Artistry',
              'Perawatan Kulit (Skincare) Dasar & Lanjut',
              'Hair Styling & Hair Cutting',
              'Hair Coloring & Hair Treatment',
              'Nail Art & Manicure Pedicure',
              'Spa Therapy & Massage',
              'Tata Rias Pengantin Tradisional & Modern',
              'Analisis Jenis Kulit & Wajah',
              'Manajemen Bisnis Kecantikan',
              'Customer Service Kecantikan',
              'Hygiene & Sanitasi Kecantikan',
              'Trend & Teknik Kecantikan Terkini'
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {[
              { name: 'Tata Rias Wajah', desc: 'Teknik makeup untuk berbagai acara dan kebutuhan' },
              { name: 'Perawatan Kulit & Wajah', desc: 'Facial treatment dan perawatan kulit profesional' },
              { name: 'Hair Styling & Cutting', desc: 'Teknik potong dan styling rambut modern' },
              { name: 'Hair Coloring', desc: 'Teknik pewarnaan dan bleaching rambut' },
              { name: 'Nail Art & Manicure', desc: 'Seni kuku dan perawatan tangan kaki' },
              { name: 'Spa & Body Treatment', desc: 'Terapi spa dan perawatan tubuh' },
              { name: 'Tata Rias Pengantin', desc: 'Makeup dan hairstyling pengantin tradisional modern' },
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  'MUA Pengantin',
                  'Beauty Consultant',
                  'Product Specialist Kecantikan',
                  'Manajer Salon / Spa',
                  'Owner Bisnis Kecantikan',
                  'Trainer Kecantikan'
                ].map((job, index) => (
                  <div
                    key={index}
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  'Teknologi Kosmetik (S1/D3)',
                  'Farmasi Kosmetik (S1/D3)',
                  'Manajemen Bisnis Kecantikan (S1/D3)',
                  'Terapi Kecantikan (S1/D3)',
                  'Pendidikan Kecantikan (S1/D3)',
                  'Kesehatan Kulit & Estetika (S1/D3)',
                  'Teknik Tata Rias (D3)',
                  'Manajemen Spa & Wellness (S1/D3)',
                  'Kriya Mode (S1/D3)',
                  'Desain Fashion (S1/D3)'
                ].map((major, index) => (
                  <div
                    key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground/70 mt-6 max-w-3xl mx-auto">
              Siswa Tata Kecantikan memiliki kesempatan PKL di berbagai tempat kecantikan terkemuka
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: 'Salon Kecantikan Premium', type: 'Beauty Salon' },
              { name: 'Spa & Wellness Center', type: 'Spa & Wellness' },
              { name: 'Beauty Clinic', type: 'Aesthetic Clinic' },
              { name: 'Studio Makeup Artist', type: 'Makeup Studio' },
              { name: 'Barbershop Modern', type: 'Hair & Grooming' },
              { name: 'Nail Art Studio', type: 'Nail Salon' },
              { name: 'Distributor Produk Kecantikan', type: 'Beauty Distributor' },
              { name: 'Hotel Bintang 5', type: 'Hotel Spa' },
              { name: 'Wedding Organizer', type: 'Wedding Services' }
            ].map((partner, index) => (
              <div
                key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              'Studio Makeup Profesional',
              'Laboratorium Perawatan Kulit (Skincare)',
              'Studio Hair Styling Lengkap',
              'Laboratorium Hair Coloring',
              'Studio Nail Art & Manicure',
              'Spa Room & Body Treatment',
              'Ruang Praktik Tata Rias Pengantin',
              'Peralatan Kecantikan Lengkap & Modern'
            ].map((facility, index) => (
              <div
                key={index}
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <div className="space-y-4">
                {[
                  ...
                  'Juara Harapan 1 Kompetisi Nail Art Tingkat Jawa Timur 2023',
                  'Finalis LKS Spa Therapy Tingkat Nasional 2023',
                  'Juara 1 Lomba Tata Rias Pengantin Tradisional 2023'
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[1, 2, 3, 4, 5, 6].map((item) => (
                  ...
                  >
                    <Sparkles className="w-10 h-10 text-blue-900/50 group-hover:scale-110 transition-transform" />
                  </div>
                ))}
              </div>
              <p className="text-foreground/60 text-sm mt-4 text-center">
                Galeri karya kecantikan siswa KC terpilih
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { name: 'BNSP SKKNI Tata Rias Wajah', level: 'Level 2', desc: 'Sertifikasi makeup profesional' },
              { name: 'BNSP SKKNI Perawatan Kulit', level: 'Level 2', desc: 'Sertifikasi skincare therapist' },
              { name: 'LSP P1 Make Up Artist', level: 'Level Okupasi', desc: 'Sertifikasi makeup artist' },
              { name: 'LSP P1 Nail Art', level: 'Level Okupasi', desc: 'Sertifikasi nail technician' },
              { name: 'Sertifikasi Hair Stylist', level: 'Level 2', desc: 'Sertifikasi profesional rambut' }
            ].map((cert, index) => (
              <div
                key={index}
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-yellow-500 mx-auto rounded-full" />
            <p className="text-lg text-foreground/70 mt-6 max-w-3xl mx-auto">
              Dokumentasi kegiatan dan pembelajaran siswa Tata Kecantikan
            </p>
          </div>
            ...
            {[
              {
                name: 'Dewi Sartika',
                year: 'Angkatan 2021',
                role: 'Makeup Artist di Surabaya',
                text: 'Program KC di SMK PGRI Wonoasri memberikan bekal keterampilan yang sangat lengkap. Dari dasar makeup hingga teknik pengantin, semua diajarkan dengan sangat detail oleh guru berpengalaman.'
              },
              {
                name: 'Siti Nurhaliza',
                year: 'Angkatan 2022',
                role: 'Mahasiswa Ilmu Kosmetik UNAIR',
                text: 'Ilmu yang saya dapatkan sangat berguna saat kuliah. Praktik intensif dan sertifikasi BNSP membantu saya lebih siap menghadapi perkuliahan.'
              },
              {
                name: 'Rina Melati',
                year: 'Siswa Kelas XII',
                role: 'Siswa Aktif',
                text: 'Belajar di KC sangat seru dan bermanfaat. Fasilitas lengkap dan banyak kesempatan untuk ikut lomba kecantikan tingkat kabupaten maupun provinsi.'
              }
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Siap Menjadi Profesional Kecantikan?</h2>
          <p className="text-xl text-yellow-400 mb-8 max-w-2xl mx-auto">
            Bergabunglah dengan Program Keahlian Tata Kecantikan SMKS PGRI Wonoasri dan wujudkan karir di industri kecantikan!
          </p>
      ...
      <footer className="bg-blue-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-blue-200">
            © 2025 SMKS PGRI Wonoasri - Program Keahlian Tata Kecantikan
          </p>
        </div>
      </footer>
    </div>
