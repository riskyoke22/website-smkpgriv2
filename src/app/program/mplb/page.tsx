...
import { ArrowLeft, GraduationCap, Target, Award, BookOpen, Briefcase, Building2, Trophy, Shield, Image as ImageIcon, Quote, FileText, Users, Calendar, Phone, Mail, Loader2 } from 'lucide-react'
...
export default function MPLBPage() {
  ...
  useEffect(() => {
    const fetchProgramContent = async () => {
      try {
        const response = await fetch('/api/program-content/mplb')
        if (response.ok) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto py-20">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
            Mencetak tenaga administrasi dan layanan bisnis profesional yang siap bekerja di berbagai sektor industri dan perkantoran
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-blue-900 to-blue-800 rounded-2xl p-8 md:p-12 text-white shadow-xl">
              ...
              <p className="text-lg leading-relaxed">
                Program Keahlian Manajemen Perkantoran & Layanan Bisnis (MPLB) SMKS PGRI Wonoasri dirancang untuk mencetak
                lulusan yang kompeten di bidang administrasi perkantoran, kearsipan, layanan pelanggan, dan manajemen bisnis.
                Siswa akan belajar menguasai berbagai keterampilan administrasi modern, pengelolaan dokumen, pelayanan prima,
                penggunaan teknologi informasi kantor, serta manajemen bisnis dasar. Program ini menggabungkan teori dengan praktik
                langsung menggunakan peralatan dan software kantor standar industri untuk mempersiapkan siswa menjadi tenaga administrasi
                profesional yang siap bekerja di berbagai perusahaan dan instansi.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <p className="text-foreground/80 leading-relaxed text-lg">
                Menjadi program keahlian MPLB unggulan yang menghasilkan lulusan berkompeten, profesional, berkarakter,
                dan siap bersaing dalam bidang administrasi perkantoran dan layanan bisnis di tingkat nasional maupun internasional.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <ul className="space-y-3 text-foreground/80">
                <li className="flex items-start gap-2">
                  ...
                  <span>Mencetak lulusan yang kompeten dalam administrasi perkantoran modern</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-500 mt-1">✓</span>
                  <span>Mengembangkan keterampilan pelayanan prima dan komunikasi bisnis</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-500 mt-1">✓</span>
                  <span>Mempersiapkan siswa menguasai teknologi informasi kantor</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-500 mt-1">✓</span>
                  <span>Menanamkan etika kerja profesional dan tanggung jawab</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              'Komunikasi Bisnis',
              'Pengelolaan Agenda & Jadwal',
              'Penggunaan Aplikasi Perkantoran',
              'Akuntansi Dasar',
              'Penanganan Telepon & Korespondensi',
              'Etika Profesi Perkantoran',
              'Manajemen Pertemuan & Rapat',
              'Pengelolaan Logistik & Inventaris'
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {[
              { name: 'Administrasi Perkantoran', desc: 'Manajemen administrasi dan tata usaha kantor' },
              { name: 'Kearsipan', desc: 'Teknik pengelolaan dan penyimpanan dokumen' },
              { name: 'Pelayanan Prima', desc: 'Teknik pelayanan pelanggan yang profesional' },
              { name: 'Komunikasi Bisnis', desc: 'Komunikasi efektif dalam lingkungan bisnis' },
              { name: 'Aplikasi Komputer Perkantoran', desc: 'Microsoft Office dan aplikasi pendukung' },
              { name: 'Akuntansi Dasar', desc: 'Pencatatan keuangan dan laporan bisnis' },
              { name: 'Kewirausahaan', desc: 'Pengembangan jiwa dan skill wirausaha' },
              { name: 'Praktik Kerja Lapangan (PKL)', desc: 'Pengalaman kerja di dunia industri' }
            ].map((subject, index) => (
              <div
                key={index}
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  'Administrasi Publik (S1/D3)',
                  'Akuntansi (S1/D3)',
                  'Manajemen Pemasaran (S1/D3)',
                  'Sekretaris (D3)',
                  'Komunikasi Bisnis (S1/D3)',
                  'Manajemen SDM (S1/D3)',
                  'Perpustakaan & Informasi (S1/D3)',
                  'Ilmu Administrasi (S1/D3)',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground/70 mt-6 max-w-3xl mx-auto">
              Siswa MPLB memiliki kesempatan PKL di berbagai perusahaan dan instansi terkemuka
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { name: 'Bank BRI Cabang', type: 'Perbankan' },
              { name: 'Pemerintah Kabupaten', type: 'Instansi Pemerintah' },
              { name: 'RSUD Wonoasri', type: 'Rumah Sakit' },
              { name: 'PT. Astra International', type: 'Manufaktur' },
              { name: 'Notaris & PPAT', type: 'Kantor Notaris' },
              { name: 'Hotel Bintang 4', type: 'Hospitality' },
              { name: 'Dinas Pendapatan Daerah', type: 'Instansi Pemerintah' },
              { name: 'CV. Maju Jaya', type: 'Perusahaan Dagang' }
            ].map((partner, index) => (
              <div
                key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              'Laboratorium Komputer Kantor',
              'Ruang Praktik Pelayanan Prima',
              'Laboratorium Akuntasi',
              'Ruang Kearsipan Modern',
              'Mini Office Center',
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <div className="space-y-4">
                {[
                  ...
                  'Juara 2 Lomba Sekretaris Tingkat Provinsi 2024',
                  'Juara Harapan 1 Kompetisi Kearsipan Tingkat Jawa Timur 2023',
                  'Finalis LKS Customer Service Tingkat Nasional 2023',
                  'Juara 1 Lomba Business Plan Tingkat Kabupaten 2023'
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
              ...
              <p className="text-foreground/60 text-sm mt-4 text-center">
                Karya administrasi dan dokumen bisnis siswa MPLB
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { name: 'Microsoft Office Specialist', level: 'Word & Excel', desc: 'Sertifikasi Microsoft resmi' },
              ...
              { name: 'Sertifikasi Kompetensi Akuntansi', level: 'Dasar', desc: 'Sertifikasi keahlian akuntansi' },
              { name: 'Sertifikasi Bahasa Inggris Bisnis', level: 'TOEIC', desc: 'Sertifikasi kemampuan bahasa' }
            ].map((cert, index) => (
              <div
                key={index}
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-yellow-500 mx-auto rounded-full" />
            <p className="text-lg text-foreground/70 mt-6 max-w-3xl mx-auto">
              Dokumentasi kegiatan dan pembelajaran siswa MPLB
            </p>
          </div>
            ...
            {[
              {
                name: 'Siti Nurhaliza',
                year: 'Angkatan 2021',
                role: 'Sekretaris di Perusahaan Multinasional',
                text: 'Program MPLB di SMK PGRI Wonoasri memberikan bekal skill administrasi yang sangat berguna. Saya langsung bisa bekerja sesuai bidang setelah lulus.'
              },
              {
                name: 'Budi Santoso',
                year: 'Angkatan 2022',
                role: 'Mahasiswa Manajemen Universitas Brawijaya',
                text: 'Ilmu administrasi dan akuntansi dasar yang diajarkan sangat membantu saat kuliah. Guru-gurunya sangat kompeten dan suportif.'
              },
              {
                name: 'Dewi Putri',
                year: 'Siswa Kelas XII',
                role: 'Siswa Aktif',
                text: 'Belajar di MPLB sangat bermanfaat. Fasilitas laboratorium lengkap dan banyak kegiatan praktik yang menunjang skill kami.'
              }
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Siap Menjadi Tenaga Administrasi Profesional?</h2>
          <p className="text-xl text-yellow-400 mb-8 max-w-2xl mx-auto">
            Bergabunglah dengan Program Keahlian Manajemen Perkantoran & Layanan Bisnis SMKS PGRI Wonoasri dan wujudkan karir di dunia administrasi dan bisnis!
          </p>
      ...
      <footer className="bg-blue-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-blue-200">
            © 2025 SMKS PGRI Wonoasri - Program Keahlian Manajemen Perkantoran & Layanan Bisnis
          </p>
        </div>
      </footer>
    </div>
